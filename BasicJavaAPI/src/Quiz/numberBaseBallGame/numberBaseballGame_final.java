...
public class numberBaseballGame_final {
    public static void main(String[] args) {
        ...
        // ======================= 확인 코드 ======================= //
//        System.out.print("Answer Numbers: ");
//        for (int a : answer) {
//            System.out.print(a + " ");
//        }
//        System.out.println("\n");
    ...
    private static boolean printAndIsCorrect(int[] answer, int[] userChoice) {
        ...
        // 숫자 범위 넘어갈 경우 범위 체크 메서드 호출. 이후 판독기 메서드 종료
    ...
    // 범위 체크기 (에러 메세지 출력)
    private static boolean isOndDigit(int n) {
        if (n > 0 && n < 10) {
            return true;
        } else {
            System.out.println("Error: Number should be one digit number without zero\n");
        }
        return false;
    }
}